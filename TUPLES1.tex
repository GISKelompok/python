...
Berikut yaitu daftar fungsi tuples bawaanya yang terdapat oleh Python:
len(tuple), dipakai untuk menghitung panjang sebuah tuples
max(tuple), dipakai untuk menghitung nilai maksimum dari elemen yang ada di tuples
min(tuple), dipakai untuk menghitung nilai minimum dari elemen yang ada di tuples
tuple(seq), dipakai untuk mengubah atau mengkonversi dari list menjadi tuples.

\subsection len(tuple)


Fungsi len(tuple) dipakai untuk menghitung panjang sebuah tuples.
...
Jika program diatas Kita jalankan, maka akan memperlihatkan output sebagai berikut:

Panjang tuple1 :  3
Panjang tuple2 :  2


\subsection max(tuple)


Fungsi max(tuple) dipakai untuk memperlihatkan nilai maksimum pada elemen yang ada dalam tuples.
...
Jika program yang ada diatas Kita jalankan, maka akan memperlihatkan output di bawah ini:
...
Fungsi pada min(tuple) dipakai untuk memperlihatkan nilai minimum pada elemen yang ada di dalam tuples.
...
Jika program yang ada diatas Kita jalankan, maka akan memperlihatkan output sebagai berikut:

Min value tuple1 :  abc
Min value tuple2 :  -200


\subsection tuple(seq)


Fungsi pada tuple(seq) dipakai untuk mengganti atau mengkonversi pada list menjadi tuples.
...
Jika pada program diatas Kita jalankan, maka akan memperlihatkan output sebagai berikut:
